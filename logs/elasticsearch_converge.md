```shell
netology@netology:~/Projects/ansible_test_roles/playbook/roles/elasticsearch-role$ molecule converge
...
+++ after: /home/netology/.ansible/tmp/ansible-local-47837jp1x16x5/tmpbzsxipvi/elasticsearch.yml.j2
@@ -1,82 +1,6 @@
...
skipping: [instance-1]
--- before: /etc/elasticsearch/elasticsearch.yml
+++ after: /home/netology/.ansible/tmp/ansible-local-47837jp1x16x5/tmpaaqwkib9/elasticsearch.yml.j2
@@ -1,82 +1,6 @@
-# ======================== Elasticsearch Configuration =========================
-#
-# NOTE: Elasticsearch comes with reasonable defaults for most settings.
